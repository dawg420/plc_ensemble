...
from shared.distributed_state import DistributedStateStore, enhanced_to_display_state, generate_state_output_summary
...
def run_llm_service_thread(model_path="saved_models/state_model/", 
    ...
    service = LLMPredictorService(model_path, base_dir)
